...
const Dashboard: React.FC<DashboardProps> = ({ onTabChange }) => {
  ...
  useEffect(() => {
    ...
    const weeklyCalories   = weeklyNutrition.reduce((s, n) => s + n.totalCalories, 0);
    ...
    setStats({
      ...
      totalCalories:  nutrition.reduce((s, n) => s + n.totalCalories, 0),
      weeklyCalories,
      currentWeight,
      bmi,
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          <ActivityItem
            ...
            subtitle="Get started with the Workouts tab"
            onClick={() => onTabChange('workouts')}
          />
          <ActivityItem
            icon={Apple}
            ...
            subtitle="Log breakfast, lunch, and dinner"
            onClick={() => onTabChange('nutrition')}
          />
          <ActivityItem
            icon={Target}
            ...
            title="Set your first fitness goal"
